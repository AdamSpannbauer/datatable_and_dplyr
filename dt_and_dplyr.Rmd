...
free intro to both packages through [datacamp](https://www.datacamp.com/home) (more than intro costs $)
...
```{r, echo=FALSE}
options(scipen=999)
df_time <- system.time(readr::read_csv("fwrite_out.csv"))
...
Sort by `ind` in descending order.
```{r, eval=FALSE}
#dplyr
df %>% 
  arrange(desc(grp))
